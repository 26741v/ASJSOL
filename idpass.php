...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $query = "INSERT INTO students (id, password, recruiter) VALUES ('$id', '$password', '$recruiter')";
  ...
  <!-- ***** Main Banner Area Start ***** -->
    <section class="section main-banner" id="top" data-section="section1">
      ...
      <div class="video-overlay header-text" style="overflow-y: auto;">
        <form method="post">
                    <h1>Method 1<h1>
               <h2>Submit your school ID, Discord Tag, and password for your plan!</br>You will be contacted soon regarding payment once you submit!</h2>
